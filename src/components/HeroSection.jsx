import img_Hero from "../assets/optimized/Image_HeroSection-480.webp";
  ...
  return (
    <div className="bg-gray-100 p-8 flex flex-col lg:flex-row items-center justify-between">
      <div className="lg:w-1/2 text-center lg:text-left p-2">
        <h1 className="text-2xl mb-4 text-[#6C2E93]">ENG CHIN HANG CONSTRUCTION PTE LTD</h1>
      ...
      <div className="lg:w-1/2 flex justify-center p-3">
        <img
          src={img_Hero}
          alt="ENG CHIN HANG CONSTRUCTION PTE LTD - Leading Construction Company in Singapore"
          loading="lazy"
          decoding="async" width="407" height="416"
